...
def create_app(test_config=None):
    ...
    def play_quiz():
        try:
            ...
            if cat['type'] == "click":
                questions = Question.query.filter(Question.id.notin_((prev_ques))).all()
            else:
                questions = Question.query.filter_by(category=str(cat['id'])).filter(Question.id.notin_((prev_ques))).all()
